-- DAY 05 (2026-08-30) - card for sql/05_vs_state_average.sql
-- STEP 1: paste this whole file into the Supabase SQL Editor and Run. Note the row count.
-- STEP 2 (the tweak): change   'READM_30_PN'   to   'SEP_1'
--          why: benchmark the sepsis bundle % instead. Higher is better here, so also flip ORDER BY diff_vs_tx to DESC.
