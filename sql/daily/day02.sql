-- DAY 02 (2026-08-27) - card for sql/02_sparse_measures_tx.sql
-- STEP 1: paste this whole file into the Supabase SQL Editor and Run. Note the row count.
-- STEP 2 (the tweak): change   > 0.5   to   > 0.25
--          why: loosen the missing-threshold from 50% to 25% - how many more measures appear?
